...
class MilliyetAdapter(BaseAdapter):
    def __init__(self):
        super().__init__(
            source_id="milliyet",
    ...
    def fetch_latest_news(self) -> list:
        ...
        # Fallback Scraper
        scrape_urls = ["https://www.milliyet.com.tr/gundem/", "https://www.milliyet.com.tr/dunya/"]
        for url in scrape_urls:
            html = self.fetch_url(url)
            if not html:
                continue
            soup = BeautifulSoup(html, "html.parser")
            cards = soup.select(".card, .news-item, a[href*='milliyet.com.tr/gundem/'], a[href*='milliyet.com.tr/dunya/']")
