...
class HalkTVAdapter(BaseAdapter):
    def __init__(self):
        super().__init__(
            source_id="halktv",
            source_name="Halk TV",
    ...
    def fetch_latest_news(self) -> list:
        rss_urls = [
            ...
            "https://halktv.com.tr/rss/gundem.xml"
        ]
        items = []
        for url in rss_urls:
        ...
        # Fallback Scraper
        scrape_urls = ["https://halktv.com.tr/gundem", "https://halktv.com.tr/dunya"]
        for url in scrape_urls:
            html = self.fetch_url(url)
            if not html:
                continue
            soup = BeautifulSoup(html, "html.parser")
            cards = soup.select(".card, article, a[href*='halktv.com.tr/gundem/'], a[href*='halktv.com.tr/dunya/']")
